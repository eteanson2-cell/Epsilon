package epsilon.model.entities.audio.wavFile;
...
public class WavFile
{
    ...
    /*public byte[] bufferToBytes(double[] sampleBuffer, int offset, int numFramesToWrite) throws IOException, WavFileException{
        if (ioState != IOState.WRITING) throw new IOException("Cannot write to WavFile instance");
